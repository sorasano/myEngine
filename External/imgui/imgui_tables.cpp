...
void ImGui::TableSetBgColor(ImGuiTableBgTarget target_, ImU32 color, int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    IM_ASSERT(target_ != ImGuiTableBgTarget_None);
    ...
    case ImGuiTableBgTarget_RowBg1:
    {
        ...
        int bg_idx = (target_ == ImGuiTableBgTarget_RowBg1) ? 1 : 0;
